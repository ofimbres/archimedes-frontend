...
import { faTrash, faCalendarDay, faCalendarTimes, faCalendarCheck } from '@fortawesome/free-solid-svg-icons';
...
const Home = () => {
  ...
  <h2 className="fs-5 text-center mb-5">Here's your activity overview for Monday, March 10, 2025</h2>
