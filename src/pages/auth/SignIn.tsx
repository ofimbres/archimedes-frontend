  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err instanceof Error && err.message) {
        if (err.message.includes('User not found')) errorMessage = 'No account found with this email. Please check your email or sign up.';
        else if (err.message.includes('password')) errorMessage = 'Incorrect password. Please try again.';
        else if (err.message.includes('network') || err.message.includes('fetch')) errorMessage = 'Network error. Please check your connection.';
